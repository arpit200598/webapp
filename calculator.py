...
btn0=Button(cal,padx=16,pady=8,bd=8, fg="black",font=('arial',20,'bold'),
            text="0",command=lambda:btnClick(0)).grid(row=4,column=0)

dec=Button(cal,padx=16,pady=8,bd=8, fg="black",font=('arial',20,'bold'),
            text=".",command=lambda:btnClick(".")).grid(row=4,column=1)
equ=Button(cal,padx=16,pady=8,bd=8, fg="black",font=('arial',20,'bold'),
...
div=Button(cal,padx=16,pady=8,bd=8, fg="black",font=('arial',20,'bold'),
            text="/",command=lambda:btnClick("/")).grid(row=4,column=3)

btnClear=Button(cal,padx=16,pady=8,bd=8, fg="black",font=('arial',20,'bold'),
